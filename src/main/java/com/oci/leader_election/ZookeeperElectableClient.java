package com.oci.leader_election;
...
public abstract class ZookeeperElectableClient implements Watcher, ZookeeperNodeDeletionMonitor.ZooZNodeDeletionMonitorListener {
	...
	ZookeeperNodeDeletionMonitor zNodeDeletionMonitor = null;
	...
	private ZookeeperNodeDeletionMonitor getZNodeDeletionMonitor() {
	...
	// Constructor
	protected ZookeeperElectableClient() throws KeeperException, IOException, InterruptedException {
	...
	private void resetZNodeDeletionMonitor() throws KeeperException, InterruptedException {
		...
		zNodeDeletionMonitor = new ZookeeperNodeDeletionMonitor( getZooKeeper(), getZNodePathToWatch( null ), this );
	}
